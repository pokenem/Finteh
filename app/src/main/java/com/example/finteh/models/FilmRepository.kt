...
class FilmRepository(private val apiClient: ApiClient) {
    ...
    suspend fun getFilmById(id: Int): Film {
        val response: Response<Film> = apiClient.apiService.getDescById(id)
        if (response.isSuccessful) {
